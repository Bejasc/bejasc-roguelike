...
from input_handlers import handle_keys, InputModes
...
def main():
    ...
    input_mode = InputModes.INPUT_NUMPAD
    ...
    inventory_component = Inventory(12)
    ...
    while not libtcod.console_is_window_closed():
        ...
        action = handle_keys(key, game_state, input_mode)
        ...
        if move and game_state == GameStates.PLAYERS_TURN:
            ...
            for entity in entities:
                ...
                message_log.add_message(Message("There is nothing here to pick up.", libtcod.blue))
